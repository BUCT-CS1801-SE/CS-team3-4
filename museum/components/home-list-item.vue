<template>
	<view class="home-list-item_yym u-f-ac_yym" 
	hover-class="home-list-hover_yym"
	@tap="clickevent">
		<view class="u-f-ac_yym">
			<view v-if="item.icon"
			class="iconfont_yym"></view>
			{{item.name}}
		</view>
		<view class="iconfont_yym" :class="{'icon-jinru_yym':!item.data}">{{item.data || ''}}</view>
	</view>
</template>
...
.home-list-item_yym>view:first-child{
	color: #333333;
}
.home-list-item_yym>view:first-child>view{
	margin-right: 10upx;
}
.home-list-item_yym>view:last-child{
	color: #CCCCCC;
}
.home-list-hover_yym{
	background: #f4f4f4;
